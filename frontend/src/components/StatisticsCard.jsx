    ...
    <div className={`bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-all border-l-4 ${colors.border}`}>
      <div className="flex items-center justify-between">
        <div className="flex-1">
          <p className="text-sm font-medium text-gray-600 mb-1 max-w-[250px] truncate">{title}</p>
          <p className="text-3xl font-bold text-gray-900 max-w-[180px] truncate">{value}</p>
          {subtitle && (
